...
<?php
	...
	include("/home/alumno/al342460/public_html/ServiQ/clases/Adm.php");
	
	$myAdm = new Adm();
	$myDao = new Dao();
	$arreglo = $myDao->consultaTabla("id_pe,id_cl,fecha_hora","pedido","status like ('ESPERA')");
	...
	for ($z = 0; $z < $j; $z++)
	{
		...
		$myAdm->mandarNotificacion($id_pe,$id_cl,1);
	}
?>
